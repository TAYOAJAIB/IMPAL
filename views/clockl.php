...
<!-- NAVBAR -->
  <!-- SORT & LAYOUT BAR -->
   ...
   <div class="container" style="margin-top: 10%">
    ...
    <h2 class="mb-4 text-primary text-center">Ini Pesawat Boeing Kami</h2>
    <div class="row" id="rw">
                        ...
                        <div class="modal-body">
                          <table>
                            ...
                            <tr>
                                <td height="50px" width="150px">Jumlah</td>
                                <td>
                                  <input type="number" name="jumlah" max="5" min="1" value="1" class="form-control" pattern="[0-9]+" required>
                                </td>
                            </tr>
                          </table> 
                        </div>
